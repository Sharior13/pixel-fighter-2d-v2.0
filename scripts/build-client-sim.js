...
const FILES = [
    ...
    // generated by scripts/build-anim-sequences.js, which must run BEFORE
    // this script (see package.json's build:sim) so this file exists to
    // mirror on a fresh checkout - see that script's header comment for
    // what generates it and why it needs mirroring here too (characterSprites.js
    // reads it browser-side the same way it reads the rest of the mirrored sim).
    ["server/data/generatedAnimSequences.js", "public/core/sim/data/generatedAnimSequences.js"],
];
